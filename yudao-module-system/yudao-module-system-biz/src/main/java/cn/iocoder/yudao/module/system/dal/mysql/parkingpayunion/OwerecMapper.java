...
public interface OwerecMapper extends BaseMapperX<Owerec> {
        ...
        return selectPage(reqVO, new LambdaQueryWrapperX<Owerec>()
                ...
                .eqIfPresent(Owerec::getChannelId, reqVO.getChannelId())
                .eqIfPresent(Owerec::getPlateColor, reqVO.getPlateColor())
//                .likeIfPresent(Owerec::getPlateNum, reqVO.getPlateNum().toUpperCase())
                .eqIfNotBlank(Owerec::getPlateNum, reqVO.getPlateNum() == null? null:reqVO.getPlateNum().toUpperCase())
