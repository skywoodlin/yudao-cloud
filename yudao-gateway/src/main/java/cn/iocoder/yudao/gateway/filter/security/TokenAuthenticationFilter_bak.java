 ...
 */
//@Component
public class TokenAuthenticationFilter_bak implements GlobalFilter, Ordered {
    ...
    public TokenAuthenticationFilter_bak(ReactorLoadBalancerExchangeFilterFunction lbFunction) {
